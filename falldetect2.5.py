...
default_email = "gottipolu.gayathri@gmail.com"
data_path = "sub_bg11"              # The default video path
...
def send_alert():
    global target_email
    sender = 'falldetectionnotification@gmail.com'
    ...
    try:
        ...
        session.ehlo()
        session.starttls()
        session.login(sender,'falldetection')
...
def do_analysis():
    ...
    file = data_path + "/Data/" + target_video + "_" + str(index).zfill(12) + "_keypoints.json"               
    try:
        fh = open(file)
    except IOError:
        index = 0
        ...
        img = PhotoImage(file = data_path + "/Image/" + target_video + "_" + str(index).zfill(12) + "_rendered.png")
...
# Title
title_label = Label(top, text = "Falling Detection", font = "Helvetica 16 bold")   
